...
func convertTemplateRequestField(fieldName string, iface interface{}) (interface{}, error) {
	...
	return nil, makeError(btcjson.ErrInvalidType, str)
}
...
func makeError(c btcjson.ErrorCode, desc string) btcjson.Error {
	return btcjson.Error{ErrorCode: c, Description: desc}
}
...
func init() {
	...
	btcjson.MustRegisterCmd("addnode", (*AddNodeCmd)(nil), flags)
	btcjson.MustRegisterCmd("createrawtransaction", (*CreateRawTransactionCmd)(nil), flags)
	btcjson.MustRegisterCmd("decoderawtransaction", (*DecodeRawTransactionCmd)(nil), flags)
	btcjson.MustRegisterCmd("decodescript", (*DecodeScriptCmd)(nil), flags)
	btcjson.MustRegisterCmd("getaddednodeinfo", (*GetAddedNodeInfoCmd)(nil), flags)
	btcjson.MustRegisterCmd("getbestblockhash", (*GetBestBlockHashCmd)(nil), flags)
	btcjson.MustRegisterCmd("getblock", (*GetBlockCmd)(nil), flags)
	btcjson.MustRegisterCmd("getblockchaininfo", (*GetBlockChainInfoCmd)(nil), flags)
	btcjson.MustRegisterCmd("getblockcount", (*GetBlockCountCmd)(nil), flags)
	btcjson.MustRegisterCmd("getblockhash", (*GetBlockHashCmd)(nil), flags)
	btcjson.MustRegisterCmd("getblockheader", (*GetBlockHeaderCmd)(nil), flags)
	btcjson.MustRegisterCmd("getblocktemplate", (*GetBlockTemplateCmd)(nil), flags)
	btcjson.MustRegisterCmd("getcfilter", (*GetCFilterCmd)(nil), flags)
	btcjson.MustRegisterCmd("getcfilterheader", (*GetCFilterHeaderCmd)(nil), flags)
	btcjson.MustRegisterCmd("getchaintips", (*GetChainTipsCmd)(nil), flags)
	btcjson.MustRegisterCmd("getconnectioncount", (*GetConnectionCountCmd)(nil), flags)
	btcjson.MustRegisterCmd("getdifficulty", (*GetDifficultyCmd)(nil), flags)
	btcjson.MustRegisterCmd("getgenerate", (*GetGenerateCmd)(nil), flags)
	btcjson.MustRegisterCmd("gethashespersec", (*GetHashesPerSecCmd)(nil), flags)
	btcjson.MustRegisterCmd("getinfo", (*GetInfoCmd)(nil), flags)
	btcjson.MustRegisterCmd("getmempoolentry", (*GetMempoolEntryCmd)(nil), flags)
	btcjson.MustRegisterCmd("getmempoolinfo", (*GetMempoolInfoCmd)(nil), flags)
	btcjson.MustRegisterCmd("getmininginfo", (*GetMiningInfoCmd)(nil), flags)
	btcjson.MustRegisterCmd("getnetworkinfo", (*GetNetworkInfoCmd)(nil), flags)
	btcjson.MustRegisterCmd("getnettotals", (*GetNetTotalsCmd)(nil), flags)
	btcjson.MustRegisterCmd("getnetworkhashps", (*GetNetworkHashPSCmd)(nil), flags)
	btcjson.MustRegisterCmd("getpeerinfo", (*GetPeerInfoCmd)(nil), flags)
	btcjson.MustRegisterCmd("getrawmempool", (*GetRawMempoolCmd)(nil), flags)
	btcjson.MustRegisterCmd("getrawtransaction", (*GetRawTransactionCmd)(nil), flags)
	btcjson.MustRegisterCmd("gettxout", (*GetTxOutCmd)(nil), flags)
	btcjson.MustRegisterCmd("gettxoutproof", (*GetTxOutProofCmd)(nil), flags)
	btcjson.MustRegisterCmd("gettxoutsetinfo", (*GetTxOutSetInfoCmd)(nil), flags)
	btcjson.MustRegisterCmd("getwork", (*GetWorkCmd)(nil), flags)
	btcjson.MustRegisterCmd("help", (*HelpCmd)(nil), flags)
	btcjson.MustRegisterCmd("invalidateblock", (*InvalidateBlockCmd)(nil), flags)
	btcjson.MustRegisterCmd("ping", (*PingCmd)(nil), flags)
	btcjson.MustRegisterCmd("preciousblock", (*PreciousBlockCmd)(nil), flags)
	btcjson.MustRegisterCmd("reconsiderblock", (*ReconsiderBlockCmd)(nil), flags)
	btcjson.MustRegisterCmd("searchrawtransactions", (*SearchRawTransactionsCmd)(nil), flags)
	btcjson.MustRegisterCmd("sendrawtransaction", (*SendRawTransactionCmd)(nil), flags)
	btcjson.MustRegisterCmd("setgenerate", (*SetGenerateCmd)(nil), flags)
	btcjson.MustRegisterCmd("stop", (*StopCmd)(nil), flags)
	btcjson.MustRegisterCmd("submitblock", (*SubmitBlockCmd)(nil), flags)
	btcjson.MustRegisterCmd("uptime", (*UptimeCmd)(nil), flags)
	btcjson.MustRegisterCmd("validateaddress", (*ValidateAddressCmd)(nil), flags)
	btcjson.MustRegisterCmd("verifychain", (*VerifyChainCmd)(nil), flags)
	btcjson.MustRegisterCmd("verifymessage", (*VerifyMessageCmd)(nil), flags)
	btcjson.MustRegisterCmd("verifytxoutproof", (*VerifyTxOutProofCmd)(nil), flags)
}
